  ...
  return (
    <>
        ...
        >
          <Col className="card-preguntas" xs={12} md={5}>
            <p style={{ fontSize: "20px" }}>
              <strong className="titulo-strong"> Contratación Directa</strong>{" "}
              <br />
          ...
          <Col className="card-preguntas" xs={12} md={5}>
            <p style={{ fontSize: "20px" }}>
              <strong className="titulo-strong"> Selección abreviada</strong>{" "}
              <br />
          ...
          <Col className="card-preguntas" xs={12} md={5}>
            <p style={{ fontSize: "20px" }}>
              <strong className="titulo-strong"> Minima Cuantía</strong> <br />
          ...
          <Col className="card-preguntas" xs={12} md={5}>
            <p style={{ fontSize: "20px" }}>
              <strong className="titulo-strong"> Licitación pública</strong>{" "}
              <br />
          ...
          <Col className="card-preguntas" xs={12} md={5}>
            <p style={{ fontSize: "20px" }}>
              <strong className="titulo-strong"> Concurso de Méritos</strong>{" "}
              <br />
      ...
      >
        ...
        >
          <p
            style={{ color: "#605F5F", fontSize: "24px", margin: "80px 0px " }}
          >
            ...
            <span> potenciales.proveedores@palmira.gov.co</span>
          </p>
        </Col>
      </Row>
    </>
